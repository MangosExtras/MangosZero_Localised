...
UPDATE `trans_words`SET `content_loc8`='Look for the Zeppelin Landing Tower outside of the city to the southeast.' WHERE `word_id`=192794; -- locales_npc_text - Text1_0 : entry=3173
...
UPDATE `trans_words`SET `content_loc8`='I\'m sad to see that the furbolgs could have been corrupted so easily, before they were our friends.' WHERE `word_id`=214162; -- locales_npc_text - Text1_1 : entry=10560
UPDATE `trans_words`SET `content_loc8`='UDB Missing US text' WHERE `word_id`=197021; -- locales_npc_text - Text3_0 : entry=10734
UPDATE `trans_words`SET `content_loc8`='UDB Missing US text' WHERE `word_id`=197021; -- locales_npc_text - Text5_0 : entry=10734
UPDATE `trans_words`SET `content_loc8`='UDB Missing US text' WHERE `word_id`=197021; -- locales_npc_text - Text7_0 : entry=10734
