...
UPDATE `locales_points_of_interest` SET `icon_name_loc3`='Ausgediente Schurkenweste' WHERE `entry`=119;
UPDATE `locales_points_of_interest` SET `icon_name_loc3`='Alanna Rabenauge' WHERE `entry`=120;
UPDATE `locales_points_of_interest` SET `icon_name_loc3`='Rohlingsstiefel' WHERE `entry`=121;
